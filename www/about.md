...
12. If any of the plate model parameters (station coordinates or Euler's pole parameters) is modified, the model will be deactivated until the user sets again the `show` or `remove` option with the new parameters.  
