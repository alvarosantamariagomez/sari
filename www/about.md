...
12. The `full series` option will expand the plot area to show both the *primary* and *secondary series*. By default, the plot are only includes the *primary series*.  
13. If the coordinate components of either the *primary* or the *secondary* series are unknown, the `N@E` option can be used to swap the North and East components of the *secondary series* to match the components of the *primary series*.  
