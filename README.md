...
- locally on your machine using the [source code](app.R) after installing R, RStudio and all the R dependencies given in the [INSTALL](INSTALL) file. Once all is set just, download, open and run the source code or simply execute `runGitHub("sari","alvarosantamariagomez")`  
